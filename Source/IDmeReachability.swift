...
public class IDmeReachability {
    
    public typealias NetworkReachable = (IDmeReachability) -> ()
    public typealias NetworkUnreachable = (IDmeReachability) -> ()
...
public extension IDmeReachability {
...
fileprivate extension IDmeReachability {
...
extension SCNetworkReachabilityFlags {
    ...
    typealias Connection = IDmeReachability.Connection
...
private class ReachabilityWeakifier {
    weak var reachability: IDmeReachability?
    init(reachability: IDmeReachability) {
